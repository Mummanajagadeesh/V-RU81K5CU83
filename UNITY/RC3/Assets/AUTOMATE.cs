...
public class AUTOMATE : MonoBehaviour
{
    ...
    void Update()
    {
        if (moveList.Count > 0  && !CUBE_STATE.autoRotating && CUBE_STATE.started)
        {
    ...
    void RotateSide(List<GameObject> side, float angle)
    {
        ...
        PIVOT_ROTATION pr = side[4].transform.parent.GetComponent<PIVOT_ROTATION>();
